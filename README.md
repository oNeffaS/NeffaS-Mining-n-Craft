...
## Crafting Tools and Workstation Performance

Crafting tools have been separated from workbenches and now have their own crafting skill, called **Crafting Tools**. With this change, by reading the **Machine Tools Manual**, players can unlock a variety of tools that improve the performance of their workstations. Additionally, each tool now has levels, and these levels directly affect the efficiency of forges and other crafting stations.

![](https://i.imgur.com/nexTz6K.png)

### Tool Details and Effects:
- **Advanced Bellows**: Reduces smelting time by 5% to 20%.
- **Anvils**: Reduces crafting time by 5% to 20%.
- **Crucible**: Reduces ingredient usage by 5% to 25%.
- **Iron Sledgehammer**: Reduces crafting time by 5% to 20%.
- **Forging Tongs**: Reduces smelting time by 5% to 20%.

**Stone Grinding Wheel**: Reduces crafting time by 5% to 20%.

In addition to these improvements, players can increase their chances of obtaining more loot by investing points in the **Advanced Engineering** skill.

This update also paves the way for future mods, which will utilize the tool system with levels attached to workbenches, offering a more strategic and deeper progression for players.

### Concrete Mixer

![](https://i.imgur.com/IXXo5nx.png)

The ***Concrete Mixer*** now uses ***gasoline*** as fuel. After all, this engine can't run on willpower alone.
And thanks to the **[IDC CORE](https://www.nexusmods.com/7daystodie/mods/3341)** mod, it will no longer be possible to use any other type of fuel in the concrete mixer besides gasoline.
The IDC CORE mod is only performing this function in this first version of "NeffaS' Mining & Craft", but I have many future plans for implementations made through IDC CORE for both NeffaS' Mining & Craft and my future mods.
...
The mod has been translated into all languages ​​with the help of [ChatGPT](https://chatgpt.com/), so forgive me if something is wrong. I count on the community's feedback to adjust whatever is necessary.
...
- The icon images for new ore items and new ore scrap items were generated by [Craiyon](https://www.craiyon.com/) through prompts written by **NeffaS** based on the vanilla item icons.
...
- **Special Thanks:** [ocbMaurice](https://next.nexusmods.com/profile/ocbMaurice/about-me?gameId=1059) for the mod [OCB MicroSplat](https://www.nexusmods.com/7daystodie/mods/2873), [I Dont Care](https://next.nexusmods.com/profile/idc12/about-me?gameId=1059) for the mod [IDC CORE](https://www.nexusmods.com/7daystodie/mods/3341) and to the entire Discord community [Guppy's Unofficial 7D2D Modding Server](https://discord.gg/sFtTQ3B55p) who are always ready to help and were crucial to making my first mod possible.
